...
const tiers = [
  {
    ...
    price: "0",
    description: [
      "Encontre e contrate profissionais",
      "Seja contratado",
  ...
  },
  {
    ...
    description: [
      ...
      "Encontre e contrate profissionais",
      "Seja contratado",
      "Tenha acesso ao Dashboard para gerenciar seus lucros e contratos",
      "Acesso ao centro de ajuda",
  ...
  },
  {
    ...
    description: [
      ...
      "Acesso a todos os recursos dos planos anteriores",
      "Dashboard avançado para gerenciar lucros e contratos",
